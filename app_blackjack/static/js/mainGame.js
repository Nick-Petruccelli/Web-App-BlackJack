...
class BlackJackGame{
    ...
    startGame(){
        ...
        for(let i = 0; i < 2; i++){
            ...
            div.appendChild(img)
            img.src = "../static/img/cards/"+card.suit+card.value+".png";
            img.id = "Card";
        ...
        div.appendChild(img)
        img.src = "../static/img/cards/back.png";
        img.id = "Card";
        dealerHand.appendChild(div);
        div.style.position = "absolute";
        div.style.width = "50%";
    ...
    stand(){
        ...
        downCardFace.src = "../static/img/cards/"+this.dealersDownCard.suit+this.dealersDownCard.value+".png";
